...
class TrafficSimulationGUI:
    def __init__(self):
        ...
        self.blinking = True
        self.root.after(500, self.toggle_rsu_visualization)
    ...
    def toggle_rsu_visualization(self):
        self.blinking = not self.blinking
        for tl_id in self.tl_ids:
            try:
                traci.gui.toggleSelection(tl_id, self.blinking)
            except traci.exceptions.TraCIException as e:
                print(f"Error toggling RSU visualization: {e}")
        self.root.after(500, self.toggle_rsu_visualization)
        ...
        try:
            ...
            for tl_id, rsu_id in self.rsus.items():
                ...
                if detected_vehicles:
                    ...
                    detected_info.append(f"RSU {tl_id}: {', '.join(detected_vehicles)}")
