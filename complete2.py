...
class RSU:
    ...
    def update_poi_appearance(self):
        ...
        try:
            ...
            # We'll alternate between normal and larger size based on simulation step
            ...
            # This could happen if the POI doesn't exist yet
...
class TrafficSimulationGUI:
    ...
    def create_rsus(self):
        """Create RSUs at traffic light junctions and add visual representation on the map"""
        for i, tl_id in enumerate(self.tl_ids):
            try:
                ...
                try:
                    # Add a red diamond POI at the RSU location
                    traci.poi.add(rsu.poi_id, junction_pos[0], junction_pos[1], (255, 0, 0, 255), "RSU", 20, 1)
                    
                    # Add a circle POI to show detection range
...
def visualize_rsu_detection_range():
    """Add visualization of RSU detection ranges to the simulation"""
    # This function would be called once at the start of the simulation
    # to add circle POIs that represent the detection range of each RSU
    pass
